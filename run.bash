...
for site in NR31677_Suldal #32087_Dovre  32032_VestreToten 31780_Vaaler 31941_Roeyrvik #32374_Saltdal 31652_Bygland 31767_Kongsvinger

do
  cp options.nml /home/ecaas/soil_decomp/results/${description}/options_${description}_${site}.txt
  clm_data_file='/home/ecaas/nird/'${site}'_historical_obsveg/lnd/hist/'${site}
  clm_surface_file='/home/ecaas/nird/surface_files_copy/'${site}'/surfdata_'${site}'_observed_simyr2000.nc'
