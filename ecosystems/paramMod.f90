...
real(kind=r8),parameter                      :: fCLAY  = 0.07                   ![-] fraction of clay in soil
...
real(kind=r8),dimension(MM_eqs),parameter    :: Kslope  = (/0.039, 0.039, -0.009, 0.031, 0.018, 0.017/)!LITm, LITs, SOMa entering SAPb, LITm, LITs, SOMa entering SAPf
real(kind=r8),dimension(MM_eqs),parameter    :: Vslope  = (/0.064, 0.064, 0.042, 0.053, 0.052, 0.063/) !LITm, LITs, SOMa entering SAPb, LITm, LITs, SOMa entering SAPf
real(kind=r8),dimension(MM_eqs),parameter    :: Kint    = (/1.37, 2.88, 3.86, 3.39, 3.69, 3.19/)       !LITm, LITs, SOMa entering SAPb, LITm, LITs, SOMa entering SAPf
real(kind=r8),dimension(MM_eqs),parameter    :: Vint    = (/3.68, 5.85, 3.74, 2.74, 5.51, 5.47/)       !LITm, LITs, SOMa entering SAPb, LITm, LITs, SOMa entering SAPf
real(r8),parameter                           :: pscalar = 1.0/(2*exp(-2.0*dsqrt(fclay)))
real(kind=r8),dimension(MM_eqs)              :: Kmod    = (/1d0, 5d0, 0.5d0*pscalar, 0.5d0, 0.5d0, 0.5d0*pscalar/)!LITm, LITs, SOMa entering SAP
real(kind=r8),dimension(MM_eqs)              :: Vmod    = (/2.0,  1.0, 2.0, 2.0, 2.0, 2.0/)            !LITm, LITs, SOMa entering SAPb, LITm, LITs, SOMa entering SAPf
...
real(r8), dimension(nlevdecomp), parameter   :: f_depth = (/1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4/)
