...
dDIN = N_SAPbDIN + N_SAPfDIN + Deposition - N_DINEcM - N_DINErM - N_DINAM - N_DINplant
...
dSAPb_N = N_LITmSAPb + N_LITsSAPb + N_SOMaSAPb - N_SAPbSOMp - N_SAPbSOMa - N_SAPbSOMc
dSAPb_C = C_LITmSAPb + C_LITsSAPb + C_SOMaSAPb - C_SAPbSOMp - C_SAPbSOMa - C_SAPbSOMc

dSAPb_N = N_LITmSAPf + N_LITsSAPf + N_SOMaSAPf - N_SAPfSOMp - N_SAPfSOMa - N_SAPfSOMc
dSAPb_C = C_LITmSAPf + C_LITsSAPf + C_SOMaSAPf - C_SAPfSOMp - C_SAPfSOMa - C_SAPfSOMc
...
dSOMc_N = N_SAPbSOMc + N_SAPfSOMc + N_EcMSOMc + N_ErMSOMc + N_AMSOMc
dSOMc_C = C_SAPbSOMc + C_SAPfSOMc + C_EcMSOMc + C_ErMSOMc + C_AMSOMc - C_SOMcSOMa

dSOMa_N = N_SAPbSOMa + N_SAPfSOMa + N_EcMSOMa + N_ErMSOMa + N_AMSOMa - N_SOMaSAPb - N_SOMaSAPf - N_SOMaEcM - N_SOMaErM - N_SOMaAM
dSOMa_C = C_SAPbSOMa + C_SAPfSOMa + C_EcMSOMa + C_ErMSOMa + C_AMSOMa +  C_SOMcSOMa + C_SOMpSOMa - C_SOMaSAPf - C_SOMaSAPb

dSOMp_N = N_SAPbSOMp + N_SAPfSOMp + N_EcMSOMp + N_ErMSOMp + N_AMSOMp
