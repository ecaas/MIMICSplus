...
real(kind=r8),parameter                       :: tsoi   = 5.3                   ![degC]
real(kind=r8),parameter                       :: fclay  = 0.12                  ![-] fraction of clay in soil
real(kind=r8),dimension(4)                    :: MGE = (/ 0.55,0.75,0.25,0.35 /)![mg/mg] Microbial growth efficiency/Carbon Use efficiency. The fraction of the flux from litter pools that is used in microbial processes.
...
real(r8)                                      :: I_tot= 10.0                    ![gC/m2/day]
real(r8)                                      :: f_litm=0.4, f_lits=0.4, f_ecm=0.05, f_erm=0.05, f_am=0.05,&
                                                 f_som1=0.025, f_som2=0.025
real(r8)                                      :: f_myc_levels=0.25, f_lit_1=0.7, f_lit_234=0.1
...
real(kind=r8),dimension(3),parameter          :: k2 = (/0.0007,0.00014,0.0007/)![1/day](EcM_sapr, ErM_sapr, AM_sapr,EcM_sapr, ErM_sapr, AM_sapr) decay constants, MYC to SOM pools
...
real(kind=r8),parameter,dimension(MM_eqs)     :: Vmax = (/ 0.012, 0.002, 0.012, 0.003, 0.003, &
                                                        0.002, 0.012, 0.002, 0.012, 0.003, 0.003, 0.002, 0.012/)*24![mgC/((mgSAP)h)]*24= [mgC/(mgSAP*day)]  For use in Michaelis menten kinetics. TODO: Is mgSAP only carbon?
!end MM parameters
...
real(kind=r8), parameter                      :: fMET = 0.3846423 !From original mimics, "Partitioning of litter inputs to LIT_m"
