program main
  ...
  character (len=*),parameter :: description = "test_nitrification"
  ...
  do name = 1, 1, 1    
    ...
    !2: SPINUP
    call decomp(nsteps=200*24*365, run_name=trim(trim(site_names(name))//"_"//description//"_"//"Spunup"),nlevdecomp=levels, step_frac=1, write_hour=24*365*10,&
